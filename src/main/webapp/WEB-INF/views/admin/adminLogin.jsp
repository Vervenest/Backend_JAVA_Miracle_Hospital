...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Miracle Hospital</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <p>
                                    <span id='greentext' style='color:#9efdd2;'></span>
                                    <span id='redtext' style='color:#ffb3b3;'></span>
                                </p>
                                <!-- <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="${pageContext.request.contextPath}/assets/images/logo.png" alt="" >
                                </a> -->
                                <h1 class="text-white-50" style="color: ffffff !important;">Miracle Hospital</h1>
                            </div>
                            <!-- <p class="mt-3 fs-15 fw-medium">EmPower</p> -->
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" novalidateid="loginForm" method="post" action="${pageContext.request.contextPath}/adminmodel/loginemail">


                                        <div class="mb-3">
                                            <label for="username" class="form-label">Email</label>
                                            <input type="email" class="form-control" name="email" id="validationCustom01" placeholder="Enter Email">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> Vervenest. Powered with <i class="mdi mdi-heart text-danger"></i> by Vervenest
                            </p>
                        </div>
                    </div>
                </div>
